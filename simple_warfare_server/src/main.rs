...
use simple_warfare_server::{
    SimpleWarfareServerPlugins,
    consts::GAME_VERSION,
    server::message::{
...
fn main() {
    ...
    app.add_plugins(DefaultPlugins)
        ...
        .add_systems(OnEnter(ServerState::StartServerWaiting), open_server)
        .add_systems(
            Update,
            receiver_client_message.run_if(in_state(ServerState::StartServerWaiting)),
        )
