use crate::{
    ...
    custom::map::navigator_layer::{
        NavigatorLayerPlugin,
        northstar::{CustomGridLayersServer, NorthstarGridEntitiesStorage},
    },
};
use bevy::prelude::*;
...
impl CustomModHandle {
    pub fn new(mod_root: String, info: Handle<ModInfo>, main_lua: Handle<LuaAsset>) -> Self {
        Self {
            mod_root,
            info,
            main_lua,
