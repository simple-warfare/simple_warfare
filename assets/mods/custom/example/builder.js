...
class Builder extends CustomUnit {
    constructor() {
        super()
        this.core = manyFromValues.core("建造者", 100, 100, 100, 100., 100., 100., true)
        this.graphics.push(manyFromValues.graphic(undefined, "builder.png", undefined, undefined, undefined))
        this.movement = manyFromValues.movement(MovementType.LAND, 10., 3., 3., 10., 10., 10., 10.)
        this.colliders.push(new CircleCollider(ColliderType.Circle, 20.))

        this.created_func = () => {
            this.teleportSelfTo(manyFromValues.vec2(
        ...
        this.pointLights.push(new PointLight2d(manyFromValues.transform(manyFromValues.vec3(10., 0., 0.), undefined, undefined), 50., Color(colors.red), 0.2, 130., false))
        this.pointLights.push(new PointLight2d(manyFromValues.transform(manyFromValues.vec3(-10., 0., 0.), undefined, undefined), 50., Color(colors.red), 0.2, 130., false))

        this.pointLights.push(new PointLight2d(manyFromValues.transform(manyFromValues.vec3(-15., -10., 0.), undefined, undefined), 50., Color(colors.red), 0.2, 130., false))
        this.pointLights.push(new PointLight2d(manyFromValues.transform(manyFromValues.vec3(15., -10., 0.), undefined, undefined), 50., Color(colors.red), 0.2, 130., false))
    }
}
